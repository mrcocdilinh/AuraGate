    ...
    <div>
      <section className="container-page pt-16 sm:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base text-muted sm:text-lg">
            AI agents discover APIs, pay <strong className="text-ink">USDC per request</strong> with x402
            — no API keys, no subscriptions — and get an on-chain receipt as proof of quality.
            Sellers list a service and get paid instantly.
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link href="/services" className="btn-primary w-full sm:w-auto">Browse marketplace</Link>
            <Link href="/playground" className="btn-ghost w-full sm:w-auto">Watch an agent pay →</Link>
          </div>
          <p className="mt-4 text-xs text-muted">Sign in with email or Google — a Circle wallet is created for you.</p>
        </div>
        ...
        <div className="mx-auto mt-16 grid max-w-4xl gap-4 sm:grid-cols-4">
          {[
            ...
            <div key={t} className="card p-4 text-center">
              <div className="mx-auto mb-2 grid h-8 w-8 place-items-center rounded-full bg-primary/15 text-sm font-bold text-primary">{i + 1}</div>
      ...
      <section className="container-page mt-24 grid gap-5 md:grid-cols-2">
        <div className="card p-7">
          ...
          <Link href="/playground" className="btn-ghost mt-6">Try the agent playground</Link>
        </div>
        <div className="card p-7">
          ...
          <Link href="/dashboard" className="btn-ghost mt-6">Open seller dashboard</Link>
        </div>
      </section>
      ...
      <section className="container-page mt-24">
        <div className="card relative overflow-hidden p-7 sm:p-10">
          ...
          <p className="mt-3 max-w-2xl text-sm text-muted">
            The AuraPredict prediction-market indexer is listed on AuraGate as a paid oracle/insight service.
          </p>
          <Link href="/services/market-insight" className="btn-primary mt-6">View the service</Link>
        </div>
      </section>
    </div>
  );
