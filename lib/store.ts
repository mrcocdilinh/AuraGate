...
/**
 * In-memory store, seeded on boot. Shared across API routes and server
 * components within the same Node process.
 *
 * This is the MVP persistence layer. The production target is Supabase
 * (Postgres + Realtime); the function surface below maps 1:1 to those tables
